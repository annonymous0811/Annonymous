...
def resnet18(pth_url, pretrained=False, **kwargs):
    return _resnet(BasicBlock, [2, 2, 2, 2], pretrained, pth_url, **kwargs)

def resnet34(pth_url, pretrained=False, **kwargs):
    return _resnet(BasicBlock, [3, 4, 6, 3], pretrained, pth_url, **kwargs)
